--[[
    DefaultRoom - Salle par défaut pour Roblox
    Ce ModuleScript crée la salle par défaut avec ses objets
]]
...
if not roomsFolder:FindFirstChild("DefaultRoom") then
    ...
    print("✅ DefaultRoom créé dans ServerStorage")
else
    print("✅ DefaultRoom existe déjà")
end
