...
local GetRoomsListFunction = Instance.new("RemoteFunction")
GetRoomsListFunction.Name = "GetRoomsList"
GetRoomsListFunction.Parent = RemoteEvents

GetRoomsListFunction.OnServerInvoke = function(player)
